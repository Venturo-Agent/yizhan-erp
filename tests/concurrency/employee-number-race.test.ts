...
const skipReason = '需 SUPABASE_SERVICE_ROLE_KEY、source ~/.config/venturo/secrets.env 後再跑'
...
describe.skipIf(!hasServiceRoleKey())('generate_employee_number 並發競態', () => {
  ...
  it('10 並發 call → 回 10 個不同的 E001-E010', async () => {
    const N = 10
  ...
  it('帶有現存 employees 時、新編號 > 現有 MAX 且連續', async () => {

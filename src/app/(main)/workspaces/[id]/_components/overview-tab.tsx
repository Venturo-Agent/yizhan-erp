                        ...
                        return (
                          <div key={f.name} className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-morandi-primary leading-tight">
                              {f.name}
                              {f.note && (
                                <span className="text-morandi-secondary"> ({f.note})</span>
                              )}
                            </span>
                          </div>
                        )
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col min-w-0 flex-1">
                      <span className="text-xs font-medium text-morandi-primary truncate">
                        {f.name}
                      </span>
                      {f.note && (
                        <span className="text-[10px] text-morandi-secondary">{f.note}</span>
                      )}
                    </div>
                    <Switch
                      checked={isEnabled}

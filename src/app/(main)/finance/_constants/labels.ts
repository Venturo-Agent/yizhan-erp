...
export const REQUEST_ITEM_LIST_LABELS_PATCH = {
  成本轉移: '成本轉移',
}
...
export const REQUEST_DETAIL_FORM_LABELS = {
  同批次請款單N張共金額: (count: number, _amount: number) => `同批次請款單 (${count} 張，共 `,
  請款日期: '請款日期',
  總金額: '總金額',
  類別: '類別',
  付款對象: '付款對象',
...
// Re-export shared finance labels (FinanceLabels, FINANCE_PAGE_LABELS, etc.)

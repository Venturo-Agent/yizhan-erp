      ...
      <DialogContent level={1} className="max-w-5xl max-h-[90vh] flex flex-col overflow-hidden">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {t('customerImportTitle')}
          </DialogTitle>
          <DialogDescription>{t('customerImportDescription')}</DialogDescription>
        </DialogHeader>
          ...
          {step === 'upload' && (
            <>
              ...
              <div className="flex justify-center">
                ...
                >
                  <Download size={16} />
                  {t('customerImportBtnDownloadTemplate')}
                </Button>
              </div>
            </>
          )}

...
export const SIDEBAR_META: Record<string, SidebarMeta> = {
  ...
  finance: {
    ...
    children: [
      { href: '/finance/payments', label: COMP_LAYOUT_LABELS.收款管理, icon: Wallet, feature: 'finance.payments' },
      { href: '/finance/requests', label: COMP_LAYOUT_LABELS.請款管理, icon: HandCoins, feature: 'finance.requests' },
      { href: '/finance/treasury/disbursement', label: COMP_LAYOUT_LABELS.出納管理, icon: Wallet, feature: 'finance.disbursement' },
      { href: '/finance/reports', label: COMP_LAYOUT_LABELS.報表管理, icon: BarChart3, feature: 'finance.reports' },
  ...
  accounting: {
    ...
    children: [
      { href: '/accounting/vouchers', label: COMP_LAYOUT_LABELS.傳票管理, icon: FileText, feature: 'accounting.vouchers' },
      { href: '/accounting/accounts', label: COMP_LAYOUT_LABELS.科目管理, icon: BookOpen, feature: 'accounting.accounts' },
      { href: '/accounting/period-closing', label: COMP_LAYOUT_LABELS.期末結轉, icon: Calendar, feature: 'accounting.period-closing' },
      { href: '/accounting/checks', label: COMP_LAYOUT_LABELS.票據管理, icon: FileCheck, feature: 'accounting.checks' },
      { href: '/accounting/reports', label: COMP_LAYOUT_LABELS.會計報表, icon: BarChart3, feature: 'accounting.reports' },
    ],
  },
  database: {
    icon: Library,
    ...
    href: '/library',
    children: [
      { href: '/library/customers', label: COMP_LAYOUT_LABELS.顧客管理, icon: Contact, feature: 'database.customers' },
      { href: '/library/attractions', label: COMP_LAYOUT_LABELS.旅遊資料庫, icon: Palmtree, feature: 'database.attractions' },
      { href: '/library/suppliers', label: COMP_LAYOUT_LABELS.供應商管理, icon: Building2, feature: 'database.suppliers' },
      { href: '/library/archive-management', label: COMP_LAYOUT_LABELS.封存管理, icon: Archive, feature: 'database.archive' },
    ],
  },
  hr: {
    icon: IdCard,
    ...
    children: [
      ...
      { href: '/hr/organization', label: COMP_LAYOUT_LABELS.組織管理, icon: Network, feature: 'hr.organization' },
      { href: '/hr/salary-settlement', label: '薪資結算', icon: Wallet, feature: 'hr_salary_settlement' },

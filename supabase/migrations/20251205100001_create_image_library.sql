-- Migration: Create image_library table
...
-- 建立索引
CREATE INDEX IF NOT EXISTS idx_image_library_workspace_id ON public.image_library(workspace_id);
CREATE INDEX IF NOT EXISTS idx_image_library_category ON public.image_library(category);
CREATE INDEX IF NOT EXISTS idx_image_library_country_id ON public.image_library(country_id);
CREATE INDEX IF NOT EXISTS idx_image_library_city_id ON public.image_library(city_id);
CREATE INDEX IF NOT EXISTS idx_image_library_attraction_id ON public.image_library(attraction_id);

...
-- 問題：使用 member_id 但表格欄位是 employee_id，且缺少 workspace_id
...
BEGIN
  ...
  WHERE (c.channel_type = 'direct' OR c.channel_type = 'DIRECT' OR c.type = 'direct')
  ...
  -- 如果沒找到，建立新頻道
  INSERT INTO public.channels (workspace_id, created_by, name, channel_type, type, is_announcement)
  VALUES (p_workspace_id, p_user_1_id, 'dm:' || p_user_1_id || ':' || p_user_2_id, 'direct', 'direct', false)
